...
import { NOTE_TYPES } from "./SelectNoteType";
...
export const NoteItem = ({ note, selectedType }: Props) => {
...
const Icon = noteType?.icon || FileText;
  ...
  return (
    <NoteCard
        header={
            <>
                <div className={cn("absolute inline-flex items-center left-0 top-0 shadow text-amber-50 space-x-1.5 p-0.5 rounded-tl-sm", noteType?.color)}>
